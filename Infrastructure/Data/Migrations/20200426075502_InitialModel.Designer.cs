...
namespace Infrastructure.Data.Migrations
{
    ...
    [Migration("20200426075502_InitialModel")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ApplicationCore.Entities.BasketAggegate.Basket", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("ApplicationCore.Entities.BasketAggegate.BasketItem", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("ApplicationCore.Entities.BasketAggegate.BasketItem", b =>
                {
                    b.HasOne("ApplicationCore.Entities.BasketAggegate.Basket", null)
            ...
            modelBuilder.Entity("ApplicationCore.Entities.OrderAggregate.OrderItem", b =>
                {
                    ...
                    b.OwnsOne("ApplicationCore.Entities.OrderAggregate.CatalogItemOrdered", "CatalogItemOrdered", b1 =>
                        {
